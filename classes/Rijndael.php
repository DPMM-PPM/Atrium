...
class Rijndael extends SymmetricKey
{
    ...
    public function __construct($mode)
    {
        ...
        if ($this->mode == self::MODE_STREAM) {
            throw new ilAtriumException($lng->txt('rep_robj_xatr_no_bloks_in_stream_mode'));
        }
    }
    ...
    protected function setup()
    {
        ...
        if (is_string($this->iv) && strlen($this->iv) != $this->block_size) {
            throw new ilAtriumException(sprintf(
                $lng->txt('rep_robj_xatr_iv_not_compatible'),
                strlen($this->iv),
                $this->block_size
            ));
        }
